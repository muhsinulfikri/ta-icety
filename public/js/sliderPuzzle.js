document.addEventListener("DOMContentLoaded", function () {
    ...
    slider.addEventListener("input", function () {
        ...
        puzzleContainer.style.backgroundPositionX = `-${sliderValue}px`;

        if (sliderValue == 100) { // Atur nilai sesuai dengan panjang slider untuk menyelesaikan puzzle
            sliderMoved = true;
            document.getElementById("puzzleSuccess").value = "solved";
            alert("Puzzle solved!");
        }
    });
