    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-8 pe-0 pe-md-4 d-flex flex-column gap-3">
                ...
                <div>
                    <?php if ($event->DATA_CHECKING == 0 && $event->EXPIRED != 1) { ?>
                        <button data-id-activity="<?= $event->ID_ACTIVITY ?>" onclick="AddToCart(this)"
                            class="mt-2 button button-enroll-course btn btn-secondary btn-sm rounded">
                            Join Now
                        </button>
                    <?php } else { ?>
                        <label class="text-black" style="align-items: center">Event Expired</label>
                    <?php } ?>
            ...
            <div class="col-12 col-md-3 ms-0 ms-md-4 mt-4 mt-md-0 rounded-3 overflow-hidden h-100" style="background-color: #E3E3E3;">
                <div>
                    <img src="<?= $event->IMAGE_ACTIVITY ?>" class="img-fluid w-100" />
                </div>
                <div class="d-flex flex-column gap-3 py-3 px-4">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            ...
                            <div class="font" style="font-size: 0.9rem;margin-top: -4px"><?= date('F d, Y', strtotime($event->DATE_START)) ?></div>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="font" style="font-size: 0.9rem;margin-top: -4px">Until <?= date('F d, Y', strtotime($event->DATE_END)) ?></div>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="font" style="font-size: 0.9rem;margin-top: -4px"><?= $event->PRICE_ACTIVITY == 0 ? 'Free' : 'Rp ' . number_format($course->PRICE_ACTIVITY, 2, ',', '.') ?> to learn</div>
                        </div>
                    </div>
                    <div>
                        <?php if ($event->DATA_CHECKING == 0 && $event->EXPIRED != 1) { ?>
...
<section class="pb-7">
    <div class="container ">
        ...
        <div class="d-grid gap-4 course-grid-template event-container">
...
<script>
    ...
    const eventData = @json($other_event);
