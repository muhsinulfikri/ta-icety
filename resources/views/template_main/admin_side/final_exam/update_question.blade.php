    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group text-right mt-5">
                <button type="button" class="btn btn-primary btn-submit-form" onclick="saveKuis(this)" data-id="{{ $item['ID_DETAIL'] }}">Simpan Kuis</button>
            </div>
        </div>
    </div>
</div>
<script>
    function saveKuis(button) {
