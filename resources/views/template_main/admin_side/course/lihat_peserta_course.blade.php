...
<div class="main-content">
    ...
    <div class="card-body">
        <div class="col-md-6 align-self-center">
            <h3 class="fw-bold" style="color:#45b104">Course Participant List</h3>
        </div>
        <div class="mb-3 mt-3 row headerz" style="">
            <div class="col-md-6 col-sm-12">
                <div class="d-flex">
                    <div class="d-flex flex-column flex-grow-1"><span
                            class="font-weight-bolder font-size-lg text-primary mb-1">{{ $kursus->TITLE_ACTIVITY }}</span>
                        <span class="text-dark-50 font-weight-normal font-size-sm"></span>
                        <img src="{{ $kursus->IMAGE_ACTIVITY }}"
