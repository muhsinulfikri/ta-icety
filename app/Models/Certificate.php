...
class Certificate extends Model
{
    ...
    public function generateCourseSekolah($namaUser, $activity_name, $sertificate_no, $template_link, $summary, $info_sertif, $duration, $date, $id_sertif, $institusi_name)
    {
        set_time_limit(120);
        try {
            $encryptedId = Crypt::encryptString($id_sertif);
